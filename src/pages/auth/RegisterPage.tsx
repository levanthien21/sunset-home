    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F9F8F6] p-4 font-sans relative">
      ...
      >
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-[10px] text-yellow-600 tracking-[0.3em] uppercase font-bold ml-1">Tạo tài khoản mới</p>
        </div>
        ...
        {success && (
          <div className="mb-6 bg-green-50 text-green-600 p-3 rounded-xl text-sm font-medium text-center border border-green-100">
            {success}
          </div>
        )}
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            <label className="block text-xs font-bold text-stone-500 uppercase tracking-wider mb-2">Họ và tên</label>
        ...
        <div className="mt-8 pt-6 border-t border-stone-100 text-center">
          <p className="text-sm text-stone-500 font-medium">
            Đã có tài khoản? <Link to="/login" className="text-yellow-600 hover:text-yellow-700 font-bold">Đăng nhập</Link>
          </p>
        </div>
      </motion.div>
    </div>
