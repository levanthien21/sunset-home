...
const regex = /className="flex-1 md:flex-none flex items-center justify-center px-5 py-2\.5 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-colors font-medium text-sm"\s*>\s*<div className="flex justify-center py-12">/;

const modalContent = `className="flex-1 md:flex-none flex items-center justify-center px-5 py-2.5 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-colors font-medium text-sm"
              >
